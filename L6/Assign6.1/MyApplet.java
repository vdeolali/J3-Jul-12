...
public class MyApplet extends JApplet implements ActionListener, ItemListener
{
    JTextField tfInput;
    JLabel lblInput;
    JButton goButton, resetButton;
    JComboBox  comboBox;
    String[] selection = {"Select", "www.google.com", "www.yahoo.com", "www.bing.com"};
	...
	if (event.getStateChange() == ItemEvent.SELECTED){
	    ...
	    String strUrl = "" ;
	    strUrl =  selection[comboBox.getSelectedIndex()];
	    strUrl = "http://"+strUrl;
	    URL url = null;
	    try{
                url = new URL(strUrl);
